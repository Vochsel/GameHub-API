...
exports.StartTimer = function(a_ID, a_callback, a_delayInSeconds) {
	//Clear timer if ID has been used before
	if(Utils.Valid(exports.Timers[a_ID])) {
		exports.ClearTimer(a_id);
	}

	//Create new timer
	var timer = setTimeout(a_callback, a_delayInSeconds * 1000);
	exports.Timers[a_timerID] = timer;
    return timer;
}

exports.ClearTimer = function(a_ID) {
	//Clear timeout
