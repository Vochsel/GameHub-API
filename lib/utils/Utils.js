...
exports.FormatStringWithData = function (source, a_data) {
    ...
    while (match != null) {
        ...
        if (val) {
            ...
            console.log("[Formatter] Could not find any variable called " + injVarPath + " in data supplied!");
        }
...
exports.LoadFileAsync = function (a_path, a_isLocal) {
            ...
            fs.readFile(fPath, "utf8", function (err, buffer) {
                ...
                if (err) reject(err);
                    ...
                    switch (ftype) {
                        case "js":
                            resolve(buffer);
                            //var robj = Eval(buffer/* , Object.assign(module.exports.CreateContext(), a_opts) */);
